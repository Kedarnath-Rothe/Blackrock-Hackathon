            ...
            <header>
                <div className="container">
                    <div className="logo-brand">
                        <NavLink className='l' to="/" onClick={closeMenu}> <img width={250} src='/images/icon.png'/> </NavLink>
                    </div>
                        ...
                        <ul>
                            ...
                            {user.isAdmin ? (
                                ...
                                <>
                                    ...
                                    <li>
                                        <NavLink className='navlink' to="/userhome" onClick={closeMenu}>Dashboard</NavLink>
                                    </li>
                                </>
                            ) : (
                                <li>
